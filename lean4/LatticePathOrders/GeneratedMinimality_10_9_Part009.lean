import LatticePathOrders.GeneratedMinimality_10_9_Part009_Region0036
import LatticePathOrders.GeneratedMinimality_10_9_Part009_Region0037
import LatticePathOrders.GeneratedMinimality_10_9_Part009_Region0038
import LatticePathOrders.GeneratedMinimality_10_9_Part009_Region0039
...
def regionsPart009 : List (Path × Nat × AssignmentTree) := [
  (mustParsePath "RRRRURUURR", 9, region_0036),
  (mustParsePath "RRRRURUURU", 9, region_0037),
  (mustParsePath "RRRRURUUU", 10, region_0038),
  (mustParsePath "RRRRUURRRR", 9, region_0039)
]
