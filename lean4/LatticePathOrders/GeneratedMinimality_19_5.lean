import LatticePathOrders.GeneratedMinimality_19_5_Frontier
import LatticePathOrders.GeneratedMinimality_19_5_Group000
...
theorem partitionFrontier_regions :
  ...
  unfold partitionFrontier regions regionsGroup000 regionsPart000 regionsPart001 regionsPart002 regionsPart003 regionsPart004 regionsPart005 regionsPart006 regionsPart007 regionsPart008 regionsPart009 regionsPart010 regionsPart011 regionsPart012 regionsPart013 regionsPart014
  rfl
...
theorem regions_cover : TreeRegionsCover 19 5 classes regions partitionTree :=
  ⟨classes_valid, partitionTree_check, regions_frontier, regions_valid⟩

theorem problem63_19_5 : Problem63HoldsAt 19 5 :=
  problem63HoldsAt_of_treeRegionsCover (by decide) (by decide) regions_cover

/-- Endpoint certificate: 58 regions. -/
theorem region_count : regions.length = 58 := by
