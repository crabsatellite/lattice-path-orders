import LatticePathOrders.GeneratedMinimality_10_9_Part003_Region0012
import LatticePathOrders.GeneratedMinimality_10_9_Part003_Region0013
import LatticePathOrders.GeneratedMinimality_10_9_Part003_Region0014
import LatticePathOrders.GeneratedMinimality_10_9_Part003_Region0015
...
def regionsPart003 : List (Path × Nat × AssignmentTree) := [
  (mustParsePath "RRRRRURRUR", 9, region_0012),
  (mustParsePath "RRRRRURRUU", 9, region_0013),
  (mustParsePath "RRRRRURURR", 9, region_0014),
  (mustParsePath "RRRRRURURU", 9, region_0015)
]
