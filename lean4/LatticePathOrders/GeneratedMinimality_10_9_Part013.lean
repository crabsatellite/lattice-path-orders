import LatticePathOrders.GeneratedMinimality_10_9_Part013_Region0052
import LatticePathOrders.GeneratedMinimality_10_9_Part013_Region0053
import LatticePathOrders.GeneratedMinimality_10_9_Part013_Region0054
import LatticePathOrders.GeneratedMinimality_10_9_Part013_Region0055
...
def regionsPart013 : List (Path × Nat × AssignmentTree) := [
  (mustParsePath "RRRURRRURR", 9, region_0052),
  (mustParsePath "RRRURRRURU", 9, region_0053),
  (mustParsePath "RRRURRRUUR", 9, region_0054),
  (mustParsePath "RRRURRRUUU", 9, region_0055)
]
