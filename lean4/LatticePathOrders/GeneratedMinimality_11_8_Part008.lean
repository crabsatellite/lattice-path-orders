import LatticePathOrders.GeneratedMinimality_11_8_Part008_Region0032
import LatticePathOrders.GeneratedMinimality_11_8_Part008_Region0033
import LatticePathOrders.GeneratedMinimality_11_8_Part008_Region0034
import LatticePathOrders.GeneratedMinimality_11_8_Part008_Region0035
...
def regionsPart008 : List (Path × Nat × AssignmentTree) := [
  (mustParsePath "RRRRURRRUU", 9, region_0032),
  (mustParsePath "RRRRURRURR", 9, region_0033),
  (mustParsePath "RRRRURRURU", 9, region_0034),
  (mustParsePath "RRRRURRUUR", 9, region_0035)
]
