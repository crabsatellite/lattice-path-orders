import LatticePathOrders.GeneratedMinimality_10_9_Part012_Region0048
import LatticePathOrders.GeneratedMinimality_10_9_Part012_Region0049
import LatticePathOrders.GeneratedMinimality_10_9_Part012_Region0050
import LatticePathOrders.GeneratedMinimality_10_9_Part012_Region0051
...
def regionsPart012 : List (Path × Nat × AssignmentTree) := [
  (mustParsePath "RRRRUUURU", 10, region_0048),
  (mustParsePath "RRRURRRRR", 10, region_0049),
  (mustParsePath "RRRURRRRUR", 9, region_0050),
  (mustParsePath "RRRURRRRUU", 9, region_0051)
]
