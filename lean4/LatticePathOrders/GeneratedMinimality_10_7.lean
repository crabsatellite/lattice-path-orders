import LatticePathOrders.GeneratedMinimality_10_7_Frontier
import LatticePathOrders.GeneratedMinimality_10_7_Group000
...
theorem regions_cover : TreeRegionsCover 10 7 classes regions partitionTree :=
  ⟨classes_valid, partitionTree_check, regions_frontier, regions_valid⟩

theorem problem63_10_7 : Problem63HoldsAt 10 7 :=
  problem63HoldsAt_of_treeRegionsCover (by decide) (by decide) regions_cover

/-- Endpoint certificate: 30 regions. -/
theorem region_count : regions.length = 30 := by
