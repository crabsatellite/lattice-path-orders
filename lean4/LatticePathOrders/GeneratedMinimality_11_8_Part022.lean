import LatticePathOrders.GeneratedMinimality_11_8_Part022_Region0088
import LatticePathOrders.GeneratedMinimality_11_8_Part022_Region0089
import LatticePathOrders.GeneratedMinimality_11_8_Part022_Region0090
import LatticePathOrders.GeneratedMinimality_11_8_Part022_Region0091
...
def regionsPart022 : List (Path × Nat × AssignmentTree) := [
  (mustParsePath "RRURRRUURU", 9, region_0088),
  (mustParsePath "RRURRURRRR", 9, region_0089),
  (mustParsePath "RRURRURRRU", 9, region_0090),
  (mustParsePath "RRURRURRUR", 9, region_0091)
]
