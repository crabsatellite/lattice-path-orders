import LatticePathOrders.GeneratedMinimality_11_8_Part007_Region0028
import LatticePathOrders.GeneratedMinimality_11_8_Part007_Region0029
import LatticePathOrders.GeneratedMinimality_11_8_Part007_Region0030
import LatticePathOrders.GeneratedMinimality_11_8_Part007_Region0031
...
def regionsPart007 : List (Path × Nat × AssignmentTree) := [
  (mustParsePath "RRRRRUUURU", 9, region_0028),
  (mustParsePath "RRRRURRRRR", 9, region_0029),
  (mustParsePath "RRRRURRRRU", 9, region_0030),
  (mustParsePath "RRRRURRRUR", 9, region_0031)
]
