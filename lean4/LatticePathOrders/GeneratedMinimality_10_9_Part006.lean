import LatticePathOrders.GeneratedMinimality_10_9_Part006_Region0024
import LatticePathOrders.GeneratedMinimality_10_9_Part006_Region0025
import LatticePathOrders.GeneratedMinimality_10_9_Part006_Region0026
import LatticePathOrders.GeneratedMinimality_10_9_Part006_Region0027
...
def regionsPart006 : List (Path × Nat × AssignmentTree) := [
  (mustParsePath "RRRRRUUUU", 10, region_0024),
  (mustParsePath "RRRRURRRR", 10, region_0025),
  (mustParsePath "RRRRURRRUR", 9, region_0026),
  (mustParsePath "RRRRURRRUU", 9, region_0027)
]
