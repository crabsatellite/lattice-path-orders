import LatticePathOrders.GeneratedMinimality_11_6_Frontier
import LatticePathOrders.GeneratedMinimality_11_6_Group000
...
theorem partitionFrontier_regions :
  ...
  unfold partitionFrontier regions regionsGroup000 regionsPart000 regionsPart001 regionsPart002 regionsPart003 regionsPart004
  rfl
...
theorem regions_valid : ∀ region ∈ regions,
    region.1.length + region.2.1 = 17 ∧
      region.2.2.check 11 6 classes region.2.1 region.1 = true := by
  intro region h
  exact regionsGroup000_valid region h

theorem regions_cover : TreeRegionsCover 11 6 classes regions partitionTree :=
  ⟨classes_valid, partitionTree_check, regions_frontier, regions_valid⟩

theorem problem63_11_6 : Problem63HoldsAt 11 6 :=
  problem63HoldsAt_of_treeRegionsCover (by decide) (by decide) regions_cover

/-- Endpoint certificate: 19 regions. -/
theorem region_count : regions.length = 19 := by
