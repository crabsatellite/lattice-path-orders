import LatticePathOrders.GeneratedMinimality_11_8_Part009_Region0036
import LatticePathOrders.GeneratedMinimality_11_8_Part009_Region0037
import LatticePathOrders.GeneratedMinimality_11_8_Part009_Region0038
import LatticePathOrders.GeneratedMinimality_11_8_Part009_Region0039
...
def regionsPart009 : List (Path × Nat × AssignmentTree) := [
  (mustParsePath "RRRRURRUUU", 9, region_0036),
  (mustParsePath "RRRRURURRR", 9, region_0037),
  (mustParsePath "RRRRURURRU", 9, region_0038),
  (mustParsePath "RRRRURURUR", 9, region_0039)
]
