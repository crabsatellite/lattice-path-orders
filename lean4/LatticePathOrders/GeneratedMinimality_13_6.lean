import LatticePathOrders.GeneratedMinimality_13_6_Frontier
import LatticePathOrders.GeneratedMinimality_13_6_Group000
...
theorem partitionFrontier_regions :
  ...
  unfold partitionFrontier regions regionsGroup000 regionsPart000 regionsPart001 regionsPart002 regionsPart003 regionsPart004 regionsPart005 regionsPart006 regionsPart007 regionsPart008
  rfl
...
theorem regions_cover : TreeRegionsCover 13 6 classes regions partitionTree :=
  ⟨classes_valid, partitionTree_check, regions_frontier, regions_valid⟩

theorem problem63_13_6 : Problem63HoldsAt 13 6 :=
  problem63HoldsAt_of_treeRegionsCover (by decide) (by decide) regions_cover

/-- Endpoint certificate: 33 regions. -/
theorem region_count : regions.length = 33 := by
