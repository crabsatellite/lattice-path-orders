import LatticePathOrders.GeneratedMinimality_11_7_Frontier
import LatticePathOrders.GeneratedMinimality_11_7_Group000
...
theorem regions_cover : TreeRegionsCover 11 7 classes regions partitionTree :=
  ⟨classes_valid, partitionTree_check, regions_frontier, regions_valid⟩

theorem problem63_11_7 : Problem63HoldsAt 11 7 :=
  problem63HoldsAt_of_treeRegionsCover (by decide) (by decide) regions_cover

/-- Endpoint certificate: 45 regions. -/
theorem region_count : regions.length = 45 := by
