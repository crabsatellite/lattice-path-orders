import LatticePathOrders.GeneratedMinimality_10_9_Part002_Region0008
import LatticePathOrders.GeneratedMinimality_10_9_Part002_Region0009
import LatticePathOrders.GeneratedMinimality_10_9_Part002_Region0010
import LatticePathOrders.GeneratedMinimality_10_9_Part002_Region0011
...
def regionsPart002 : List (Path × Nat × AssignmentTree) := [
  (mustParsePath "RRRRRRUURU", 9, region_0008),
  (mustParsePath "RRRRRRUUUR", 9, region_0009),
  (mustParsePath "RRRRRRUUUU", 9, region_0010),
  (mustParsePath "RRRRRURRR", 10, region_0011)
]
