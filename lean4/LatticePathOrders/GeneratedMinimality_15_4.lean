import LatticePathOrders.GeneratedMinimality_15_4_Frontier
import LatticePathOrders.GeneratedMinimality_15_4_Group000
...
theorem regions_cover : TreeRegionsCover 15 4 classes regions partitionTree :=
  ⟨classes_valid, partitionTree_check, regions_frontier, regions_valid⟩

theorem problem63_15_4 : Problem63HoldsAt 15 4 :=
  problem63HoldsAt_of_treeRegionsCover (by decide) (by decide) regions_cover

/-- Endpoint certificate: 7 regions. -/
theorem region_count : regions.length = 7 := by
