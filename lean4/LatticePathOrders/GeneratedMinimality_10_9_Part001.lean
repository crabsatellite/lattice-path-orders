import LatticePathOrders.GeneratedMinimality_10_9_Part001_Region0004
import LatticePathOrders.GeneratedMinimality_10_9_Part001_Region0005
import LatticePathOrders.GeneratedMinimality_10_9_Part001_Region0006
import LatticePathOrders.GeneratedMinimality_10_9_Part001_Region0007
...
def regionsPart001 : List (Path × Nat × AssignmentTree) := [
  (mustParsePath "RRRRRRURR", 10, region_0004),
  (mustParsePath "RRRRRRURUR", 9, region_0005),
  (mustParsePath "RRRRRRURUU", 9, region_0006),
  (mustParsePath "RRRRRRUURR", 9, region_0007)
]
