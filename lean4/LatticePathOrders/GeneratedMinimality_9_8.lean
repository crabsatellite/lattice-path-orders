import LatticePathOrders.GeneratedMinimality_9_8_Frontier
import LatticePathOrders.GeneratedMinimality_9_8_Group000
...
theorem regions_cover : TreeRegionsCover 9 8 classes regions partitionTree :=
  ⟨classes_valid, partitionTree_check, regions_frontier, regions_valid⟩

theorem problem63_9_8 : Problem63HoldsAt 9 8 :=
  problem63HoldsAt_of_treeRegionsCover (by decide) (by decide) regions_cover

/-- Endpoint certificate: 34 regions. -/
theorem region_count : regions.length = 34 := by
