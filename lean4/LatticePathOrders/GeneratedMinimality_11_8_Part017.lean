import LatticePathOrders.GeneratedMinimality_11_8_Part017_Region0068
import LatticePathOrders.GeneratedMinimality_11_8_Part017_Region0069
import LatticePathOrders.GeneratedMinimality_11_8_Part017_Region0070
import LatticePathOrders.GeneratedMinimality_11_8_Part017_Region0071
...
def regionsPart017 : List (Path × Nat × AssignmentTree) := [
  (mustParsePath "RRRURURURU", 9, region_0068),
  (mustParsePath "RRRUURRRRR", 9, region_0069),
  (mustParsePath "RRRUURRRRU", 9, region_0070),
  (mustParsePath "RRRUURRRUR", 9, region_0071)
]
