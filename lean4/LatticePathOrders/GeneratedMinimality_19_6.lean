import LatticePathOrders.GeneratedMinimality_19_6_Frontier
import LatticePathOrders.GeneratedMinimality_19_6_Group000
import LatticePathOrders.GeneratedMinimality_19_6_Group001
import LatticePathOrders.GeneratedMinimality_19_6_Group002
import LatticePathOrders.GeneratedMinimality_19_6_Group003
...
theorem regions_cover : TreeRegionsCover 19 6 classes regions partitionTree :=
  ⟨classes_valid, partitionTree_check, regions_frontier, regions_valid⟩

theorem problem63_19_6 : Problem63HoldsAt 19 6 :=
  problem63HoldsAt_of_treeRegionsCover (by decide) (by decide) regions_cover

/-- Endpoint certificate: 225 regions. -/
theorem region_count : regions.length = 225 := by
