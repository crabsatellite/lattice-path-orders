import LatticePathOrders.GeneratedMinimality_17_6_Frontier
import LatticePathOrders.GeneratedMinimality_17_6_Group000
import LatticePathOrders.GeneratedMinimality_17_6_Group001
...
theorem regions_cover : TreeRegionsCover 17 6 classes regions partitionTree :=
  ⟨classes_valid, partitionTree_check, regions_frontier, regions_valid⟩

theorem problem63_17_6 : Problem63HoldsAt 17 6 :=
  problem63HoldsAt_of_treeRegionsCover (by decide) (by decide) regions_cover

/-- Endpoint certificate: 124 regions. -/
theorem region_count : regions.length = 124 := by
