import LatticePathOrders.GeneratedMinimality_11_8_Part021_Region0084
import LatticePathOrders.GeneratedMinimality_11_8_Part021_Region0085
import LatticePathOrders.GeneratedMinimality_11_8_Part021_Region0086
import LatticePathOrders.GeneratedMinimality_11_8_Part021_Region0087
...
def regionsPart021 : List (Path × Nat × AssignmentTree) := [
  (mustParsePath "RRURRRURRU", 9, region_0084),
  (mustParsePath "RRURRRURUR", 9, region_0085),
  (mustParsePath "RRURRRURUU", 9, region_0086),
  (mustParsePath "RRURRRUURR", 9, region_0087)
]
