import LatticePathOrders.GeneratedMinimality_11_8_Part011_Region0044
import LatticePathOrders.GeneratedMinimality_11_8_Part011_Region0045
import LatticePathOrders.GeneratedMinimality_11_8_Part011_Region0046
import LatticePathOrders.GeneratedMinimality_11_8_Part011_Region0047
...
def regionsPart011 : List (Path × Nat × AssignmentTree) := [
  (mustParsePath "RRRRUURRRU", 9, region_0044),
  (mustParsePath "RRRRUURRUR", 9, region_0045),
  (mustParsePath "RRRRUURRUU", 9, region_0046),
  (mustParsePath "RRRRUURURR", 9, region_0047)
]
