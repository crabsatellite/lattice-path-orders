import LatticePathOrders.GeneratedMinimality_11_8_Part018_Region0072
import LatticePathOrders.GeneratedMinimality_11_8_Part018_Region0073
import LatticePathOrders.GeneratedMinimality_11_8_Part018_Region0074
import LatticePathOrders.GeneratedMinimality_11_8_Part018_Region0075
...
def regionsPart018 : List (Path × Nat × AssignmentTree) := [
  (mustParsePath "RRRUURRRUU", 9, region_0072),
  (mustParsePath "RRRUURRURR", 9, region_0073),
  (mustParsePath "RRRUURRURU", 9, region_0074),
  (mustParsePath "RRURRRRRRR", 9, region_0075)
]
