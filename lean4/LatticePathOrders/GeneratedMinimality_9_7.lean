import LatticePathOrders.GeneratedMinimality_9_7_Frontier
import LatticePathOrders.GeneratedMinimality_9_7_Group000
...
theorem partitionFrontier_regions :
  ...
  unfold partitionFrontier regions regionsGroup000 regionsPart000 regionsPart001 regionsPart002 regionsPart003
  rfl
...
theorem regions_cover : TreeRegionsCover 9 7 classes regions partitionTree :=
  ⟨classes_valid, partitionTree_check, regions_frontier, regions_valid⟩

theorem problem63_9_7 : Problem63HoldsAt 9 7 :=
  problem63HoldsAt_of_treeRegionsCover (by decide) (by decide) regions_cover

/-- Endpoint certificate: 15 regions. -/
theorem region_count : regions.length = 15 := by
