import LatticePathOrders.GeneratedMinimality_10_9_Part017_Region0068
import LatticePathOrders.GeneratedMinimality_10_9_Part017_Region0069
import LatticePathOrders.GeneratedMinimality_10_9_Part017_Region0070
import LatticePathOrders.GeneratedMinimality_10_9_Part017_Region0071
...
def regionsPart017 : List (Path × Nat × AssignmentTree) := [
  ...
  (mustParsePath "RRRURURUU", 10, region_0069),
  (mustParsePath "RRRURUURRR", 9, region_0070),
  (mustParsePath "RRRURUURRU", 9, region_0071)
]
