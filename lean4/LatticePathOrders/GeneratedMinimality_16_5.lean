import LatticePathOrders.GeneratedMinimality_16_5_Frontier
import LatticePathOrders.GeneratedMinimality_16_5_Group000
...
theorem partitionFrontier_regions :
  ...
  unfold partitionFrontier regions regionsGroup000 regionsPart000 regionsPart001 regionsPart002 regionsPart003 regionsPart004 regionsPart005 regionsPart006 regionsPart007
  rfl
...
theorem regions_valid : ∀ region ∈ regions,
    region.1.length + region.2.1 = 21 ∧
      region.2.2.check 16 5 classes region.2.1 region.1 = true := by
  intro region h
  exact regionsGroup000_valid region h

theorem regions_cover : TreeRegionsCover 16 5 classes regions partitionTree :=
  ⟨classes_valid, partitionTree_check, regions_frontier, regions_valid⟩

theorem problem63_16_5 : Problem63HoldsAt 16 5 :=
  problem63HoldsAt_of_treeRegionsCover (by decide) (by decide) regions_cover

/-- Endpoint certificate: 32 regions. -/
theorem region_count : regions.length = 32 := by
