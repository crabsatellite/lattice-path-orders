import LatticePathOrders.GeneratedMinimality_3_1_Frontier
import LatticePathOrders.GeneratedMinimality_3_1_Group000

set_option maxRecDepth 1000000
set_option maxHeartbeats 0

namespace LatticePathOrders.GeneratedMinimality_3_1
...
theorem regions_valid : ∀ region ∈ regions,
    region.1.length + region.2.1 = 4 ∧
      region.2.2.check 3 1 classes region.2.1 region.1 = true := by
  intro region h
  exact regionsGroup000_valid region h

theorem regions_cover : TreeRegionsCover 3 1 classes regions partitionTree :=
  ⟨classes_valid, partitionTree_check, regions_frontier, regions_valid⟩

theorem problem63_3_1 : Problem63HoldsAt 3 1 :=
...
end LatticePathOrders.GeneratedMinimality_3_1
