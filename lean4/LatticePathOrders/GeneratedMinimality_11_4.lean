import LatticePathOrders.GeneratedMinimality_11_4_Frontier
import LatticePathOrders.GeneratedMinimality_11_4_Group000

set_option maxRecDepth 1000000
set_option maxHeartbeats 0

namespace LatticePathOrders.GeneratedMinimality_11_4
...
theorem regions_valid : ∀ region ∈ regions,
    region.1.length + region.2.1 = 15 ∧
      region.2.2.check 11 4 classes region.2.1 region.1 = true := by
  intro region h
  exact regionsGroup000_valid region h

theorem regions_cover : TreeRegionsCover 11 4 classes regions partitionTree :=
  ⟨classes_valid, partitionTree_check, regions_frontier, regions_valid⟩

theorem problem63_11_4 : Problem63HoldsAt 11 4 :=
  problem63HoldsAt_of_treeRegionsCover (by decide) (by decide) regions_cover

/-- Endpoint certificate: 3 regions. -/
theorem region_count : regions.length = 3 := by
  have h := congrArg List.length partitionFrontier_regions
  simpa [partitionFrontier] using h

end LatticePathOrders.GeneratedMinimality_11_4
