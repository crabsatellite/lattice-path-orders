import LatticePathOrders.GeneratedMinimality_11_5_Frontier
import LatticePathOrders.GeneratedMinimality_11_5_Group000
...
theorem regions_cover : TreeRegionsCover 11 5 classes regions partitionTree :=
  ⟨classes_valid, partitionTree_check, regions_frontier, regions_valid⟩

theorem problem63_11_5 : Problem63HoldsAt 11 5 :=
  problem63HoldsAt_of_treeRegionsCover (by decide) (by decide) regions_cover

/-- Endpoint certificate: 6 regions. -/
theorem region_count : regions.length = 6 := by
