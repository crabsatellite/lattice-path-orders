import LatticePathOrders.GeneratedMinimality_10_9_Part021_Region0084
import LatticePathOrders.GeneratedMinimality_10_9_Part021_Region0085
import LatticePathOrders.GeneratedMinimality_10_9_Part021_Region0086
import LatticePathOrders.GeneratedMinimality_10_9_Part021_Region0087
...
def regionsPart021 : List (Path × Nat × AssignmentTree) := [
  (mustParsePath "RRURRRRRUR", 9, region_0084),
  (mustParsePath "RRURRRRRUU", 9, region_0085),
  (mustParsePath "RRURRRRURR", 9, region_0086),
  (mustParsePath "RRURRRRURU", 9, region_0087)
]
