import LatticePathOrders.GeneratedMinimality_11_8_Part019_Region0076
import LatticePathOrders.GeneratedMinimality_11_8_Part019_Region0077
import LatticePathOrders.GeneratedMinimality_11_8_Part019_Region0078
import LatticePathOrders.GeneratedMinimality_11_8_Part019_Region0079
...
def regionsPart019 : List (Path × Nat × AssignmentTree) := [
  (mustParsePath "RRURRRRRRU", 9, region_0076),
  (mustParsePath "RRURRRRRUR", 9, region_0077),
  (mustParsePath "RRURRRRRUU", 9, region_0078),
  (mustParsePath "RRURRRRURR", 9, region_0079)
]
