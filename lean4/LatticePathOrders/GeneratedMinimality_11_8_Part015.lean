import LatticePathOrders.GeneratedMinimality_11_8_Part015_Region0060
import LatticePathOrders.GeneratedMinimality_11_8_Part015_Region0061
import LatticePathOrders.GeneratedMinimality_11_8_Part015_Region0062
import LatticePathOrders.GeneratedMinimality_11_8_Part015_Region0063
...
def regionsPart015 : List (Path × Nat × AssignmentTree) := [
  (mustParsePath "RRRURRURUU", 9, region_0060),
  (mustParsePath "RRRURRUURR", 9, region_0061),
  (mustParsePath "RRRURRUURU", 9, region_0062),
