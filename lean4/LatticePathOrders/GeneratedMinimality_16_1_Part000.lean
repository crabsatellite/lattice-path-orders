import LatticePathOrders.GeneratedMinimality_16_1_Data
...
def region_0000 : AssignmentTree :=
  (.node (some (.node (some (.node (some (.node (some (.node (some (.node (some (.node (some (.node (some (.node (some (.node (some (.node (some (.node (some (.node (some (.node (some (.node (some (.node none (some (.leaf 0 false 0)))) none)) none)) none)) none)) none)) none)) none)) none)) none)) none)) none)) none)) none)) none)) none)

theorem region_0000_check :
    AssignmentTree.check 16 1 classes 16 (mustParsePath "R") region_0000 = true := by
  unfold region_0000
  rfl
