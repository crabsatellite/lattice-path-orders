...
def classChunk000 : ClassTable := .leaf #[
  { anchor := mustParsePath "RRRURRU", numerator := 338720, qMin := 194 },
  { anchor := mustParsePath "RRRRURU", numerator := 352832, qMin := 196 },
  { anchor := mustParsePath "RRRRRUU", numerator := 459680, qMin := 212 }
]
