import LatticePathOrders.GeneratedMinimality_11_8_Part000_Region0000
import LatticePathOrders.GeneratedMinimality_11_8_Part000_Region0001
import LatticePathOrders.GeneratedMinimality_11_8_Part000_Region0002
import LatticePathOrders.GeneratedMinimality_11_8_Part000_Region0003
...
def regionsPart000 : List (Path × Nat × AssignmentTree) := [
  (mustParsePath "RRRRRRRRR", 10, region_0000),
  (mustParsePath "RRRRRRRRUR", 9, region_0001),
  (mustParsePath "RRRRRRRRUU", 9, region_0002),
  (mustParsePath "RRRRRRRURR", 9, region_0003)
]
