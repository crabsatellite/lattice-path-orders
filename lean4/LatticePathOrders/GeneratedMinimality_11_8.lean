import LatticePathOrders.GeneratedMinimality_11_8_Frontier
import LatticePathOrders.GeneratedMinimality_11_8_Group000
import LatticePathOrders.GeneratedMinimality_11_8_Group001
...
theorem regions_cover : TreeRegionsCover 11 8 classes regions partitionTree :=
  ⟨classes_valid, partitionTree_check, regions_frontier, regions_valid⟩

theorem problem63_11_8 : Problem63HoldsAt 11 8 :=
  problem63HoldsAt_of_treeRegionsCover (by decide) (by decide) regions_cover

/-- Endpoint certificate: 101 regions. -/
theorem region_count : regions.length = 101 := by
