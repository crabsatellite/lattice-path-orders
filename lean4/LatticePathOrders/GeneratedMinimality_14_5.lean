import LatticePathOrders.GeneratedMinimality_14_5_Frontier
import LatticePathOrders.GeneratedMinimality_14_5_Group000
...
theorem regions_cover : TreeRegionsCover 14 5 classes regions partitionTree :=
  ⟨classes_valid, partitionTree_check, regions_frontier, regions_valid⟩

theorem problem63_14_5 : Problem63HoldsAt 14 5 :=
  problem63HoldsAt_of_treeRegionsCover (by decide) (by decide) regions_cover

/-- Endpoint certificate: 18 regions. -/
theorem region_count : regions.length = 18 := by
