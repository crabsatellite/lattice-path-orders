import LatticePathOrders.GeneratedMinimality_10_9_Part004_Region0016
import LatticePathOrders.GeneratedMinimality_10_9_Part004_Region0017
import LatticePathOrders.GeneratedMinimality_10_9_Part004_Region0018
import LatticePathOrders.GeneratedMinimality_10_9_Part004_Region0019
...
def regionsPart004 : List (Path × Nat × AssignmentTree) := [
  (mustParsePath "RRRRRURUUR", 9, region_0016),
  (mustParsePath "RRRRRURUUU", 9, region_0017),
  (mustParsePath "RRRRRUURRR", 9, region_0018),
  (mustParsePath "RRRRRUURRU", 9, region_0019)
]
