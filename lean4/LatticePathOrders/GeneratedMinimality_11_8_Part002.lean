import LatticePathOrders.GeneratedMinimality_11_8_Part002_Region0008
import LatticePathOrders.GeneratedMinimality_11_8_Part002_Region0009
import LatticePathOrders.GeneratedMinimality_11_8_Part002_Region0010
import LatticePathOrders.GeneratedMinimality_11_8_Part002_Region0011
...
def regionsPart002 : List (Path × Nat × AssignmentTree) := [
  (mustParsePath "RRRRRRURRU", 9, region_0008),
  (mustParsePath "RRRRRRURUR", 9, region_0009),
  (mustParsePath "RRRRRRURUU", 9, region_0010),
  (mustParsePath "RRRRRRUURR", 9, region_0011)
]
