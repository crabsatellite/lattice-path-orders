import LatticePathOrders.GeneratedMinimality_9_5_Frontier
import LatticePathOrders.GeneratedMinimality_9_5_Group000
...
theorem regions_valid : ∀ region ∈ regions,
    region.1.length + region.2.1 = 14 ∧
      region.2.2.check 9 5 classes region.2.1 region.1 = true := by
  intro region h
  exact regionsGroup000_valid region h

theorem regions_cover : TreeRegionsCover 9 5 classes regions partitionTree :=
  ⟨classes_valid, partitionTree_check, regions_frontier, regions_valid⟩

theorem problem63_9_5 : Problem63HoldsAt 9 5 :=
  problem63HoldsAt_of_treeRegionsCover (by decide) (by decide) regions_cover

/-- Endpoint certificate: 4 regions. -/
theorem region_count : regions.length = 4 := by
