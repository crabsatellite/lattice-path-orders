import LatticePathOrders.GeneratedMinimality_11_9_Frontier
import LatticePathOrders.GeneratedMinimality_11_9_Group000
import LatticePathOrders.GeneratedMinimality_11_9_Group001
import LatticePathOrders.GeneratedMinimality_11_9_Group002
import LatticePathOrders.GeneratedMinimality_11_9_Group003
...
theorem regions_cover : TreeRegionsCover 11 9 classes regions partitionTree :=
  ⟨classes_valid, partitionTree_check, regions_frontier, regions_valid⟩

theorem problem63_11_9 : Problem63HoldsAt 11 9 :=
  problem63HoldsAt_of_treeRegionsCover (by decide) (by decide) regions_cover

/-- Endpoint certificate: 200 regions. -/
theorem region_count : regions.length = 200 := by
