import LatticePathOrders.GeneratedMinimality_11_8_Part010_Region0040
import LatticePathOrders.GeneratedMinimality_11_8_Part010_Region0041
import LatticePathOrders.GeneratedMinimality_11_8_Part010_Region0042
import LatticePathOrders.GeneratedMinimality_11_8_Part010_Region0043
...
def regionsPart010 : List (Path × Nat × AssignmentTree) := [
  (mustParsePath "RRRRURURUU", 9, region_0040),
  (mustParsePath "RRRRURUURR", 9, region_0041),
  (mustParsePath "RRRRURUURU", 9, region_0042),
  (mustParsePath "RRRRUURRRR", 9, region_0043)
]
