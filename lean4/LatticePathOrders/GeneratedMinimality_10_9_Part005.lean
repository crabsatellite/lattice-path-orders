import LatticePathOrders.GeneratedMinimality_10_9_Part005_Region0020
import LatticePathOrders.GeneratedMinimality_10_9_Part005_Region0021
import LatticePathOrders.GeneratedMinimality_10_9_Part005_Region0022
import LatticePathOrders.GeneratedMinimality_10_9_Part005_Region0023
...
def regionsPart005 : List (Path × Nat × AssignmentTree) := [
  (mustParsePath "RRRRRUURUR", 9, region_0020),
  (mustParsePath "RRRRRUURUU", 9, region_0021),
  (mustParsePath "RRRRRUUURR", 9, region_0022),
  (mustParsePath "RRRRRUUURU", 9, region_0023)
]
