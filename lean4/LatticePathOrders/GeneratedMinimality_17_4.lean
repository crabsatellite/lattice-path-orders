import LatticePathOrders.GeneratedMinimality_17_4_Frontier
import LatticePathOrders.GeneratedMinimality_17_4_Group000
...
theorem regions_valid : ∀ region ∈ regions,
    region.1.length + region.2.1 = 21 ∧
      region.2.2.check 17 4 classes region.2.1 region.1 = true := by
  intro region h
  exact regionsGroup000_valid region h

theorem regions_cover : TreeRegionsCover 17 4 classes regions partitionTree :=
  ⟨classes_valid, partitionTree_check, regions_frontier, regions_valid⟩

theorem problem63_17_4 : Problem63HoldsAt 17 4 :=
  problem63HoldsAt_of_treeRegionsCover (by decide) (by decide) regions_cover

/-- Endpoint certificate: 8 regions. -/
theorem region_count : regions.length = 8 := by
