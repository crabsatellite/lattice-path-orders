import LatticePathOrders.GeneratedMinimality_11_8_Part005_Region0020
import LatticePathOrders.GeneratedMinimality_11_8_Part005_Region0021
import LatticePathOrders.GeneratedMinimality_11_8_Part005_Region0022
import LatticePathOrders.GeneratedMinimality_11_8_Part005_Region0023
...
def regionsPart005 : List (Path × Nat × AssignmentTree) := [
  (mustParsePath "RRRRRURURU", 9, region_0020),
  (mustParsePath "RRRRRURUUR", 9, region_0021),
  (mustParsePath "RRRRRURUUU", 9, region_0022),
  (mustParsePath "RRRRRUURRR", 9, region_0023)
]
