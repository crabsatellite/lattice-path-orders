...
theorem local_simple_four_cycle_is_tile_case0
    (directions : Int → Direction) (i₀ : Int)
    (v₁ v₂ v₃ : LocalBandVertex)
    (hcycle : LocalSimpleFourCycle directions
      (i₀, cornerZero) v₁ v₂ v₃) :
    IsLocalTileFourCycle directions (i₀, cornerZero) v₁ v₂ v₃ := by
  rcases hcycle with
    ⟨h₀₁, h₀₂, h₀₃, h₁₂, h₁₃, h₂₃, e₀₁, e₁₂, e₂₃, e₃₀⟩
  ...
  all_goals (try exact False.elim (h₂₃ rfl))
  all_goals first
    | simpa [localTileCorner, hcurrent, cornerZero, cornerOne,
        cornerTwo, cornerThree] using
        (localTile_is_four_cycle directions (.vertex i₀))
    | simpa [localTileCorner, hcurrent, cornerZero, cornerOne,
        cornerTwo, cornerThree] using
        (localTile_is_four_cycle_reverse directions (.vertex i₀))
    | simpa [localTileCorner, hcurrent, cornerZero, cornerOne,
        cornerTwo, cornerThree] using
        (localTile_is_four_cycle_rotate_one directions (.midpoint i₀))
    | simpa [localTileCorner, hcurrent, cornerZero, cornerOne,
        cornerTwo, cornerThree] using
        (localTile_is_four_cycle_rotate_one_reverse directions (.midpoint i₀))
    | simpa [localTileCorner, hcurrent, cornerZero, cornerOne,
        cornerTwo, cornerThree] using
        (localTile_is_four_cycle_rotate_three directions (.midpoint i₀))
    | simpa [localTileCorner, hcurrent, cornerZero, cornerOne,
        cornerTwo, cornerThree] using
        (localTile_is_four_cycle_rotate_three_reverse directions (.midpoint i₀))
    | omega
